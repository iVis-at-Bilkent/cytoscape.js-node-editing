    ...
    var register = function (cytoscape, $, oCanvas) {
        ...
        cytoscape('core', 'nodeResize', function (opts) {
            ...
            var clearDrawing = function () {
                ...
                // It works as expected when we do not use debounce function, but when we use debounce function on
                // window resize etc. the drawings are not cleared unexpectedly. Therefore we need to access the canvas
                // and clear the rectangle (Note that canvas.clear(false) does not work as expected as well so wee need to
                // do it manually.) TODO: Figure out the bug clearly and file it to oCanvas library.
